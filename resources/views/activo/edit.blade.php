    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row" style="margin-left: 10%">
                <div class="col-md-11">
                    <form action="{{ route('activo.update', $activo->id) }}" method="post" class="form-horizontal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="id_usuario" id="_area" class="form-control"
                                            value="{{ $activo->id_usuario }}">
                                            <option disabled>Seleccione el encargado</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea name="descripcion" id="descripcion" cols="30" rows="10" class="form-control"
                                            placeholder="Descripción">{{ $activo->descripcion }}</textarea>
